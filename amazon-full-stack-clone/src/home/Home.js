    ...
    <div className="home">
      <div className="home__container">
        ...
        <div className="home__row">
          <Product
            id="21445930"
            title="Sony PlayStation 5 Édition Standard, Avec 1 Manette Sans Fil DualSense, Couleur : Blanche"
            price={0.99}
            rating={5}
            image="https://m.media-amazon.com/images/I/61AyKaKa4TL._AC_UL480_FMwebp_QL65_.jpg"
          />
          <Product
            id="3564986837"
